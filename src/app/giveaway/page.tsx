...
export default async function Giveaway() {
  ...
  return (
    <div className='grid sm:grid-col-6 max-w-6xl w-full my-10 px-4 sm:px-6 xl:px-0 gap-y-20 overflow-hidden'>
      ...
      <Tile className='sm:col-span-6'>
        <Tile.Body className='markdown'>
          <ReactMarkdown
            ...
            components={{
              h1: ({ children }) => (
                <h1 className='giveaway-title text-2xl sm:text-4xl md:text-5xl font-bold mb-8'>{children}</h1>
              ),

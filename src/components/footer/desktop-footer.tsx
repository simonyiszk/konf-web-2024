...
export function DesktopFooter() {
  return (
    <footer className='max-w-6xl mx-auto mt-24 w-full hidden md:flex flex-col gap-10 mb-10'>
      <div className='flex flex-row justify-between'>
        ...
        <div className='flex flex-col gap-4 text-right text-xl font-medium'>
      ...
      <div className='flex flex-row justify-between items-center'>
        <div>
          <p className='text-xs'>a weboldalt készítette:</p>
        ...
        <div className='flex-grow self-end flex justify-center'>
